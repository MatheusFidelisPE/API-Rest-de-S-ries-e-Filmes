...
namespace SeriesFilmes
{
    ...
    {        
        ...
        {   
            ...
            if(!File.Exists(".\\Persistencias\\Series.bin"))
            {
            ...
            else
            {
                ...
                Stream stream = new FileStream(".\\Persistencias\\Series.bin", FileMode.Open, FileAccess.Read, FileShare.Read);  
                repositorioSerie = (SerieRepositorio) formatter.Deserialize(stream);  
                stream.Close();  
            }
            if(!File.Exists(".\\Persistencias\\Filmes.bin"))
            {
            ...
            {
                IFormatter formatter = new BinaryFormatter();  
                Stream stream = new FileStream(".\\Persistencias\\Filmes.bin", FileMode.Open, FileAccess.Read, FileShare.Read);  
        ...
        {
            IFormatter formatter = new BinaryFormatter();  
            Stream stream = new FileStream(".\\Persistencias\\Series.bin", FileMode.Create, FileAccess.Write, FileShare.None);  
        ...
        {
            IFormatter formatter = new BinaryFormatter();  
            Stream stream = new FileStream(".\\Persistencias\\Filmes.bin", FileMode.Create, FileAccess.Write, FileShare.None);  
            formatter.Serialize(stream, repositorio);  
            stream.Close();  
        }
